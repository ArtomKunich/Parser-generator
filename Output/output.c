...
int do_action(){
	...
	if(state == 3){
		switch(token_id){
			case 1: push_state(8, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 4){
		switch(token_id){
	...
	if(state == 5){
		switch(token_id){
			case 3: push_state(9, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 6){
		switch(token_id){
	...
	if(state == 7){
		switch(token_id){
			case 1: push_state(12, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 8){
		switch(token_id){
			case 0: push_state(13, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 9){
		switch(token_id){
			case 4: push_state(14, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 10){
		switch(token_id){
	...
	if(state == 13){
		switch(token_id){
			case 1: push_state(17, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 14){
		switch(token_id){
			case 3: push_state(18, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
			case 5: push_state(19, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
			case 10: push_state(20, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 15){
		switch(token_id){
	...
	if(state == 19){
		switch(token_id){
			case 7: push_state(24, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
			case 1:
	...
	if(state == 21){
		switch(token_id){
			case 1: push_state(26, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 22){
		switch(token_id){
	...
	if(state == 24){
		switch(token_id){
			case 9: push_state(30, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
			case 8:
				new_attr = "";
	...
	if(state == 25){
		switch(token_id){
			case 6: push_state(33, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
			case 1:
				new_attr = new_rule(0);
	...
	if(state == 27){
		switch(token_id){
			case 6: push_state(35, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
			case 1:
				new_attr = new_rule(0);
	...
	if(state == 31){
		switch(token_id){
			case 8: push_state(37, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 32){
		switch(token_id){
			case 7: push_state(38, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 33){
		switch(token_id){
	...
	if(state == 42){
		switch(token_id){
			case 8: push_state(44, lookahead); lookahead = get_next_token(in_fp); return state_stack[stack_pointer];
		}
	}
	if(state == 43){
		switch(token_id){
